...
private fun QuickActionTile(
    ...
    val background = if (isFocused) {
        StreameSkin.colors.surfaceRaised.copy(alpha = 0.9f)
    } else {
        StreameSkin.colors.surface.copy(alpha = 0.85f)
    }
    val outline = if (isFocused) StreameSkin.colors.focusOutline else Color.Transparent
    ...
    Column(
        ...
        Icon(
            ...
            tint = StreameSkin.colors.textPrimary.copy(alpha = contentAlpha),
        ...
        Text(
            ...
            color = StreameSkin.colors.textPrimary.copy(alpha = contentAlpha)
        )
    }
}
