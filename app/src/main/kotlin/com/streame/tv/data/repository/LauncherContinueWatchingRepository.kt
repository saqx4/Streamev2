...
import com.streame.tv.MainActivity
...
class LauncherContinueWatchingRepository @Inject constructor(
    ...
    companion object {
        ...
        private const val CHANNEL_INTERNAL_ID = "Streame_continue_watching_channel"
        private const val PREVIEW_PROGRAM_PREFIX = "Streame_continue_preview"
        private const val WATCH_NEXT_PROGRAM_PREFIX = "Streame_continue_watchnext"
        private const val URI_SCHEME = "Streame"
    ...
    private fun ensurePreviewChannel(): Long? {
        ...
        val channel = Channel.Builder()
            ...
            .setDescription("Resume watching in Streame")
...
fun Uri.toLauncherContinueWatchingRequest(): LauncherContinueWatchingRequest? {
    if (scheme != "Streame" || authority != "continue") return null
