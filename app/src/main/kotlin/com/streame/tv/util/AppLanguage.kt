...
fun tr(text: String): String {
    ...
    @StringRes val resId: Int? = when (text.trim()) {
        ...
        "Accounts",
        "Linked Accounts",
        "Optional account for syncing profiles, addons, and catalogs" -> R.string.accounts
        // Sources
        "Sources",
        ...
        "Delete Playlists",
        "Remove playlists and favorites",
        ...
        "Streame uses community streaming addons to find video sources. Without at least one streaming addon, content cannot be played." -> R.string.no_results
...
object AppTranslations {
    ...
    private val translations: Map<String, Map<String, String>> = mapOf(
        "nl" to commonUi(
            ...
            extras = mapOf(
                ...
                "Optional account for syncing profiles, addons, and catalogs" to "Optioneel account voor synchronisatie van profielen, addons, catalogi en instellingen",
                "Streame uses community streaming addons to find video sources. Without at least one streaming addon, content cannot be played." to "Streame gebruikt streaming-addons uit de community om videobronnen te vinden. Zonder minimaal een streaming-addon kan inhoud niet worden afgespeeld.",
    ...
    private fun commonUi(
        ...
        "Add Playlist" to add,
        "Add playlists" to "Playlists",
        "Create another playlist" to add,
        "Refresh Data" to refresh,
        "Refreshing data..." to loading,
        "Reload playlists now" to refresh,
        "Reload playlists now" to refresh,
        "Delete Playlists" to delete,
        "No playlists configured" to empty,
        "Remove playlists and favorites" to delete,
        "Add Catalog" to add,
        ...
        "Streame Cloud" to "Streame Cloud",
        "Optional account for syncing profiles, addons, and catalogs" to accounts,
        ...
        "Streame uses community streaming addons to find video sources. Without at least one streaming addon, content cannot be played." to noResults,
