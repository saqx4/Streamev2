...
Because this source is linked into streame's **sideload flavor** APK, that
specific build is distributed under GPL-3.0. This repository already makes
the source available at
<https://github.com/streame0/StreameV2>, satisfying GPL-3's source-distribution
